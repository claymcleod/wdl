...
The WDL *language* has a two-number version (e.g., `1.3`).
An increase in the minor (second) version number (e.g., `1.2` to `1.3`) indicates the addition of, or non-breaking changes to, the language or standard library functions.
An increase in the major (first) version number (e.g., `1.0` to `2.0`) indicates that breaking changes have been made.

The WDL *specification* has a three-number version (e.g., `1.3.0`).
...
This branch is for version **1.3** of the [WDL language specification](https://github.com/openwdl/wdl/blob/wdl-1.3/SPEC.md).
...
- [1.2](https://github.com/openwdl/wdl/blob/wdl-1.1/SPEC.md)
